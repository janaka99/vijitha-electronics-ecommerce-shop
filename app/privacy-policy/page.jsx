  ...
  return (
    <div className="flex flex-col gap-5 p-12 min-h-[calc(100vh-240px)] max-w-[1440px] mx-auto w-[95%]">
      ...
      <div className="flex flex-col justify-start gap-6">
        <h1>Privacy Policy of vijitha electronics</h1>

        <p>
          vijitha electronics operates the
          https://vijithaelectronics.netlify.app/ website, which provides the
          SERVICE.
        </p>
        ...
        <p>
          ...
          anyone decided to use our Service, the vijitha electronics website.
        </p>
        ...
        <p>
          ...
          https://vijithaelectronics.netlify.app/, unless otherwise defined in
          this Privacy Policy.
        </p>
