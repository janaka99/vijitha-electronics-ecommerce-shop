  ...
  return (
    <div className="flex flex-col gap-5 p-12 min-h-[calc(100vh-240px)] max-w-[1440px] mx-auto w-[95%]">
      ...
      <div className="flex flex-col justify-start gap-6">
        ...
        <p>Welcome to vijitha electronics!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of vijitha electronics's Website, located at
          https://vijithaelectronics.netlify.app/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use vijitha electronics if you do not
        ...
        <p>
          We employ the use of cookies. By accessing vijitha electronics, you
          agreed to use cookies in agreement with the vijitha electronics's
          Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, vijitha electronics and/or its licensors own
          the intellectual property rights for all material on vijitha
          electronics. All intellectual property rights are reserved. You may
          access this from vijitha electronics for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from vijitha electronics</li>
          <li>Sell, rent or sub-license material from vijitha electronics</li>
          <li>
            Reproduce, duplicate or copy material from vijitha electronics
          </li>
          <li>Redistribute content from vijitha electronics</li>
        </ul>
        ...
        <p>
          ...
          vijitha electronics does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of vijitha electronics,its agents and/or
          ...
          laws, vijitha electronics shall not be liable for the Comments or for
        ...
        <p>
          vijitha electronics reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant vijitha electronics a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of vijitha electronics; and (d)
        ...
        <p>
          ...
          sending an e-mail to vijitha electronics. Please include your name,
        ...
        <p>
          No use of vijitha electronics's logo or other artwork will be allowed
